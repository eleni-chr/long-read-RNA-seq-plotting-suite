...
%running featureCounts in Windows Command Line.
...
t=data(:,7:12); %extract only the columns with the counts.
...
%Save results.
writecell(info,'featureCountsSummary','Delimiter','tab'); %summary information as TXT file.
...
for k=1:numel(S)
    ...
    xlswrite('featureCountsSummary.xlsx',mat,fnm);
end
