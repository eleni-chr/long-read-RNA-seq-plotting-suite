...
down=readtable('Group_mutant_vs_wildtype_resDown2.csv','FileType','text'); %load downregulated genes.
up=readtable('Group_mutant_vs_wildtype_resUp2.csv','FileType','text'); %load upregulated genes.
...
downN=readtable('Group_mutant_vs_wildtype_resDown2.csv','FileType','text'); %load downregulated genes.
upN=readtable('Group_mutant_vs_wildtype_resUp2.csv','FileType','text'); %load upregulated genes.
