...
downN=readtable('symbolGroup_mutant_vs_wildtype_resDown.csv','FileType','text'); %load downregulated genes.
upN=readtable('symbolGroup_mutant_vs_wildtype_resUp.csv','FileType','text'); %load upregulated genes.
